...
전략 시트의 일부 생성 문장은 아직 한국어로 남습니다 — [알려진 제약](#알려진-제약) 참고.
...
- **성장 인사이트**·**10만 성장전략**의 생성 문장은 실행 시점에 조립되므로 `--lang en|ja`에서도 한국어로 출력됩니다. 시트 구조·헤더·라벨은 번역됩니다.
- 열 너비가 번역 전에 계산되어, 영문 헤더 일부가 열 너비보다 깁니다.
